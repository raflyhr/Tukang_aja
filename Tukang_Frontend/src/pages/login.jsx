        ...
        <div className="bg-surface-container-lowest rounded-3xl overflow-hidden flex flex-col md:flex-row w-full min-h-[700px] shadow-2xl border border-surface-variant/20">
          ...
          <div className="hidden md:flex md:w-1/2 bg-[#0d0d0d] relative p-12 flex-col justify-between overflow-hidden border-r border-surface-variant/20">
            ...
            <div className="relative z-10">
              <Link to="/" className="font-headline-md text-headline-md font-bold text-secondary hover:opacity-90 transition-all">
                TukangAja
              </Link>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-start gap-4">
              ...
              <h1 className="text-4xl font-extrabold text-on-surface leading-tight tracking-tight max-w-md">
                Solusi Handyman Modern untuk Rumah Anda.
              </h1>
              <p className="text-sm md:text-base text-on-surface-variant max-w-sm leading-relaxed">
                Temukan profesional terpercaya untuk segala kebutuhan perbaikan rumah Anda dengan transparan dan efisien.
              </p>
            </div>
            ...
            <div className="relative z-10 w-full h-64 rounded-2xl overflow-hidden shadow-2xl border border-surface-variant/25">
              ...
              <div 
                ...
                style={{ 
                  backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAS5AQAFLmfgQ6ns1Sza4k2GRk2wrdmMxX6V9hzURdUhUsvqvW1IlC3ALDanhWpLTQdop6E0ym4Y39EI-4q-yOiEDFEYqscP5Rh3ehP8t_sKahulJ2eJq-OoB9tJVQWjihDzYWQNZfB60NcHRgmclB_GyzW_jaL80QL3GhWjAs5-2OXF2bUGxoeZif22ZHS-EsoTbSzB1YbOCTv6ErjZ5dnYIOhspdoroiUJfrRmy0W3mKDtQzmJMw3oZi1leUYbeP8CO2-gasA3mEq')" 
                }}
              ></div>
              <div className="absolute bottom-4 left-4 z-20 flex items-center gap-2">
                <div className="flex -space-x-2">
                  <div 
                    ...
                    style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAD0dNWW0gJiE8Vf7bEISo_PLIftNs0p5c4MXKNBHE6aVSjAyI8oWUtnc7qYrg-h5kBE2GeRY1_xISiiWjKfV2eauQC-AR-Hz9aOeX8ohApU84tfkFUKvl9iKRg2UZzshKEYcq85cnD6Bo3NGiqpsYmrBX_iewkTr2c9jNRtxRc7JC2VnOoGdt94B04SZTVs9amKTeZ2r9hs2hmI_cRZ7KJx6CkSHvIzFpntnX8buB555--4udfMiphMFHnqbXTc_bS909MnQ6CRTy0')" }}
                  ></div>
                  <div 
                    className="w-8 h-8 rounded-full border-2 border-[#0d0d0d] bg-surface-container bg-cover bg-center" 
                    style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAPlNL-dwzPtBXpFW5dQr35ZSzKv7oc0JQcQgZn0xSws3eNsvvT6wxE7xPuL4XCwvjGh6XEGPPylZ7tX1mZ9U-pE2kmi7jgc8qUxD0QD_FSJYAduqFxlymI5a-oxcZArBuS6dFLwQyZB689tPwF5HE1_d9Z-cisfsFOsQZthyVwFUMJ7L3IQNC7oFOtPC3zopNxI8XViKOcGjpaK3Fi1GPMbIWrPN2ea39XAlqA01Yr3ukYlFssDyRf1SMu-cZMw2CSjq5a7kLhFTEN')" }}
                  ></div>
                </div>
                <span className="text-on-surface text-xs font-semibold">5.000+ Tukang Terverifikasi</span>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-surface-container">
            <div className="max-w-md mx-auto w-full">
              ...
              <div className="md:hidden mb-8">
                <Link to="/" className="font-headline-md text-headline-md font-bold text-secondary">
                  TukangAja
                </Link>
              </div>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center justify-between py-2">
                  ...
                  <a className="text-xs text-secondary hover:opacity-80 transition-all font-semibold" href="#">
                    Lupa Password?
                  </a>
                </div>
              ...
              <footer className="mt-8 text-center">
                <p className="text-sm text-on-surface-variant font-medium">
                  Belum punya akun?{" "} 
                  <Link className="text-secondary font-bold hover:underline transition-all" to="/">
                    Daftar Sekarang
                  </Link>
                </p>
              </footer>
